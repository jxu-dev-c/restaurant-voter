...
export function ManualWinnerForm({
  ...
  return (
    <form action={action} className="panel grid gap-5 p-6">
      <div>
        <h2 className="text-lg font-bold">Record a previous winner</h2>
      ...
      <SubmitButton disabled={!place} pendingLabel="Recording winner…">Add to winner history</SubmitButton>
    </form>
  );
}
