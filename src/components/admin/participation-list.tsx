    ...
    <section className="admin-section overflow-hidden">
      <div className="flex flex-col gap-4 border-b border-line px-5 py-5 sm:px-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h2 className="mt-2 title-content text-2xl">{submittedCount} of {voters.length} submitted</h2>
            ...
            <div className="px-5 py-4 sm:px-6" key={voter.id}>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-bold ${voter.submittedAt ? "bg-leaf-soft text-leaf" : "bg-surface-soft text-muted"}`}>
                    {voter.submittedAt ? <SuccessIcon size={13} /> : <PendingIcon size={13} />}
