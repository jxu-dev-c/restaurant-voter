    ...
    <form action={action} className="admin-section overflow-hidden">
      <section className="grid gap-5 p-5 sm:p-7">
        <div>
          ...
          <h2 className="mt-2 text-xl font-bold">Name the lunch and choose its center</h2>
        </div>
        <div>
      ...
      <section className="grid gap-5 border-t border-line p-5 sm:grid-cols-2 sm:p-7">
        <div className="sm:col-span-2">
          ...
          <h2 className="mt-2 text-xl font-bold">Set simple limits for the team</h2>
        </div>
        <div>
      ...
      <section className="grid gap-5 border-t border-line p-5 sm:p-7">
        <div>
          ...
          <h2 className="mt-2 text-xl font-bold">Choose who builds the shortlist</h2>
        </div>
