    ...
    <>
      ...
      <main className="shell max-w-3xl py-14 sm:py-20">
        ...
        <div className="mt-10 space-y-8 leading-7 text-muted">
          <section>
            <h2 className="text-xl font-bold text-ink">Referral-only access</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">Fair participation</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">Restaurant information</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink">Poll outcomes</h2>
            <p className="mt-2">
