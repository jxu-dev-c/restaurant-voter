    ...
    <>
      ...
      <main className="shell max-w-3xl py-14 sm:py-20">
        ...
        <div className="mt-10 space-y-8 leading-7 text-muted">
          <section>
            <h2 className="card-title text-xl">What we collect</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="card-title text-xl">Who can see it</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="card-title text-xl">Cookies and retention</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="card-title text-xl">Google Maps</h2>
            <p className="mt-2">
