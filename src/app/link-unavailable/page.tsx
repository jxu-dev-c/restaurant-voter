...
import { BrokenLinkIcon } from "@/components/ui/icons";
  ...
  return (
    <main className="shell grid min-h-screen place-items-center py-16">
      <div className="panel grid max-w-lg justify-items-center p-8 text-center">
        <span className="state-icon state-icon-gold">
          <BrokenLinkIcon size={22} weight="light" />
        </span>
        <p className="eyebrow mt-5">Link unavailable</p>
        <h1 className="mt-4 admin-page-title">Ask the organizer for a fresh referral link.</h1>
